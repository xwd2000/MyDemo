...
public class RegUnregReceiverActivity extends Activity implements View.OnClickListener{
	private final String TAG = "RegUnregReceiverActivity";
	private DynamicReceiver dynamicReceiver;
	private TextView tvShowRegMessage;
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.reg_unreg_receiver);
		initUiInstance();
	}

	private void initUiInstance(){
		tvShowRegMessage=(TextView)findViewById(R.id.tv_show_reg_message);
	}
	...
	private void regReceiver() {
		...
		Log.d(TAG, "注册飞行模式接收器成功");
		tvShowRegMessage.setText("注册飞行模式接收器成功");
	}
	
	private void unregReceiver() {
		if(dynamicReceiver!=null){
			unregisterReceiver(dynamicReceiver);
			Log.d(TAG, "解除飞行模式接收器成功");
			tvShowRegMessage.setText("解除飞行模式接收器成功");
		}else{
			Log.d(TAG, "解除飞行模式接收器失败");
			tvShowRegMessage.setText("解除飞行模式接收器失败");
		}
	}
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.bt_reg_receiver:
			regReceiver();
			break;

		case R.id.bt_unreg_receiver:
			unregReceiver();
			break;
