...
package com.example.mydemos.customui.scrollactivity2;
 ...
 */
public class ScrollBackActivity2 extends SwipeBackActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scroll_back_activity2);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_start:
                startActivity(new Intent(ScrollBackActivity2.this, ScrollBackActivity2.class));
                break;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.scroll_back_activity2_main, menu);
        return true;
    }
