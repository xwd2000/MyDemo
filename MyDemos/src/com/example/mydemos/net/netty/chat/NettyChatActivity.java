package com.example.mydemos.net.netty.chat;
...
import com.example.mydemos.net.netty.telnet.TelnetClientHandler;

public class NettyChatActivity extends Activity implements OnClickListener {
	private String host = "10.20.34.109";
	...
	private Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case TelnetClientHandler.MET_MESSAGE_HANDLER_KEY:
				...
				break;
			case SecureChatClientHandler.MET_MESSAGE_HANDLER_KEY:
				tvMessageShow.setText(tvMessageShow.getText() + "\n" + msg.obj);
				break;
			default:
				break;
	...
	public class MessageThread extends Thread {
		...
		public void run() {
			...
			try {
				SecureChatClientHandler tch = new SecureChatClientHandler(handler);
				Bootstrap b = new Bootstrap();
				b.group(group).channel(NioSocketChannel.class)
						.handler(new SecureChatClientInitializer(tch));
