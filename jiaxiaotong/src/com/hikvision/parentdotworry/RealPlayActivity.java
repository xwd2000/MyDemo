...
public class RealPlayActivity extends Activity implements OnClickListener, SurfaceHolder.Callback, Handler.Callback,
    ...
    private ImageView mTiletRightBtn = null;
    ...
    private void initData() {
        ...
        mLocalInfo.setScreenWidthHeight( metric.heightPixels,metric.widthPixels);
    ...
    private void initView() {
        ...
        mTitleBar.setLeftButton(R.drawable.arrow,new OnClickListener() {
        ...
        if (mRtspUrl == null) {
            RelativeLayout.LayoutParams realPlayPlayRlLp = new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT,
                    LayoutParams.WRAP_CONTENT);
            realPlayPlayRlLp.addRule(RelativeLayout.CENTER_IN_PARENT);
...
//        });
    ...
    private void startUpdateTimer() {
        ...
        mUpdateTimerTask = new TimerTask() {
            @Override
            public void run() {
                if ((mRealPlayControlRl.getVisibility() == View.VISIBLE || mTitleBar.getVisibility() == View.VISIBLE)
